...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>CORMETUR</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
         ...
         <li class="">
          ...
          <li class="">
              <a href="representantesT.php">
                <i class="fa fa-users"></i> <span>Representantes</span>
                </span>
              </a>
        ...
        <li class="">
          <a href="servicios2.php">
            <i class="fa fa-user" aria-hidden="true"></i> <span>Agregar Servicios</span>
            </span>
          </a>
        ...
        <li class="">
          <a href="actividades.php">
            <i class="fa fa-user" aria-hidden="true"></i> <span>Agregar Actividades</span>
            </span>
          </a>
